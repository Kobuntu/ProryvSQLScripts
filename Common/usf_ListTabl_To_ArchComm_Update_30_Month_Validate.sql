if exists (select 1
          from sysobjects
          where  id = object_id('usf2_ListTabl_To_ArchComm_Update_30_Month_Validate')
          and type in ('IF', 'FN', 'TF'))
   drop function usf2_ListTabl_To_ArchComm_Update_30_Month_Validate
go
...
-- ======================================================================================
create  FUNCTION [dbo].[usf2_ListTabl_To_ArchComm_Update_30_Month_Validate] (
...
END
go
grant select on usf2_ListTabl_To_ArchComm_Update_30_Month_Validate to [UserCalcService]
go
